...
specific Chinese MP3 players (AGPTEK, RUIZU, etc.). These players also support
video (AVI, AMV) under very specific encoding conditions, so this project 
provides dedicated video converters for optimal encoding.

# Video Converters

Currently provided device-specific video converters:

- Generic AVI (like [AGPTEK M6](https://a.co/d/03IkDKGJ)): [convert_agptek_m6.sh](lib/converters/convert_video_generic_avi.sh)
- Generic AMV (like [RUIZU X52](https://a.co/d/085bwkvD)): [convert_ruizu_x52.sh](lib/converters/convert_video_generic_amv.sh)
